...
> [!IMPORTANT]
> **What's New in This Fork** — this is the **vampiiluk/POSNext** fork, synced
> with upstream `develop`. It ships everything upstream **plus** the changes
> below — ideal for merchants who want a white-labeled, self-healing POS.
>
...
>   custom desktop icon.
>
> Upstream's **Shift History** dialog (with filters and CSV export) was restored
> in the latest sync — the fork no longer removes it.
